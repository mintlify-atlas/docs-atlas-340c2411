...
description: "After submitting, the MPADQ computes your scores across Symptomatology and Contributing Factors categories. Learn how to read your results and revisit them later."
---
...
All scores are presented as percentages. Because answers were converted to a 0–100 scale when stored (see the [Likert Section](/questionnaire/likert-section)), a raw average of `75` is displayed as `75%`. An N/A result is shown as the string `"N/A"` rather than a number.
